...
$sys_log = $updateTime . "usps_delivery_tracking_standard\r\n";
$array = array();


$result = mysqli_query($link, "SELECT * FROM orders o WHERE o.TrackingStatus= 'In-Transit' AND CarrierName = 'usps' AND ShipDate<'$startDate' and StoreType<>'RMA'   ORDER BY ShipDate DESC ");
