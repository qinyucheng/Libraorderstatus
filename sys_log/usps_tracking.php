...
$sys_log = $updateTime . "USPS_done\r\n";
$array = array();


$result = mysqli_query($link, "SELECT * FROM orders o WHERE(o.TrackingStatus='Wating' or o.TrackingStatus='Error' or o.TrackingStatus='') and CarrierName='usps' ORDER BY ShipDate DESC ");
