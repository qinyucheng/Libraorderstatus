...
function sys_trackingStatus($updateTime,$ShipDate,$link,&$sys_log)
	{
		...
		$result = mysqli_query($link, "SELECT * FROM orders o WHERE o.TrackingStatus= 'In-Transit' AND CarrierName = 'fedex' AND `shipclass` LIKE '%SELLER PRIME%' and ShipDate<'$ShipDate'  and StoreType<>'RMA'  ORDER BY ShipDate DESC");
		...
		$sys_log.= 'fedex_delivery_tracking_prime'.$count.'Done \r\n"';
