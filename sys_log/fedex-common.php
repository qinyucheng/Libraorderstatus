...
function getProperty($var){
  ...
  if($var == 'key') Return 'O0Fi4mGkQTcP8WZJ'; 
	if($var == 'password') Return 'fQjxSEw9FjZekDSK2INn0Ig89'; 
	if($var == 'parentkey') Return 'xxxxxxxxxxx'; 
	if($var == 'parentpassword') Return 'xxxxxxxxxx'; 
	if($var == 'shipaccount') Return '322559178';
	if($var == 'billaccount') Return 'xxxxxxxxxx';
  ...
  if($var == 'shipdate') Return '2018-05-08';
	...
	if($var == 'trackingnumber') Return '784284406720';
	if($var == 'trackingnumber2') Return '784172481292';
...
function trackDetails2($details){
