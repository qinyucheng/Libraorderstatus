...
function sys_trackingStatus($updateTime,$ShipDate,$link,&$sys_log)
	{
		...
		$result = mysqli_query($link, "SELECT * FROM orders o WHERE(o.TrackingStatus='Wating' or o.TrackingStatus='Error' or o.TrackingStatus='')  and CarrierName='fedex' ORDER BY ShipDate DESC ");
