...
$ShipDate = date("Y-m-d", strtotime("-1 days"));
...
function sys_trackingStatus($updateTime,$ShipDate,$link,&$sys_log)
	{
		...
		$result = mysqli_query($link, "SELECT * FROM orders o WHERE(o.TrackingStatus='Wating' or o.TrackingStatus='Error' or o.TrackingStatus='')  and CarrierName='fedex'   and StoreType<>'RMA' ORDER BY ShipDate DESC ");
		...
		$sys_log.= 'fedex_waitingOrders_tracking'.$count.'Done \r\n"';
