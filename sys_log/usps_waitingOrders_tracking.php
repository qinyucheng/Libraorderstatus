...
$sys_log = $updateTime . "usps_waitingOrders_tracking\r\n";
$array = array();


$result = mysqli_query($link, "SELECT * FROM orders o WHERE(o.TrackingStatus='Wating' or o.TrackingStatus='Error' or o.TrackingStatus='') and CarrierName='usps'  and StoreType<>'RMA'  ORDER BY ShipDate DESC ");
...
//$result = mysqli_query($link, "SELECT TrackingNumber FROM orders WHERE CarrierName='USPS' and TrackingStatus<>'Delivered'  and TrackingNumber<>'' and ShipDate<'2018-12-18' ");
$xml = "";
...
mysqli_close($link);
$t = time();
$filePath = "C:\\xampp\\htdocs\\Libraorderstatus\sys_log\\logs\\$t._USPS.log";
